...
--
-- Temporary table structure for view `d1`
--

DROP TABLE IF EXISTS `d1`;
/*!50001 DROP VIEW IF EXISTS `d1`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `d1` (
...
--
-- Temporary table structure for view `d1_v8`
--

DROP TABLE IF EXISTS `d1_v8`;
/*!50001 DROP VIEW IF EXISTS `d1_v8`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `d1_v8` (
  `code` tinyint NOT NULL,
...
INSERT INTO `products` VALUES (1,'Hard drive',240,5),(2,'HDD',120,6),(3,'ZIP drive',150,4),(4,'Floppy disk',5,6),(5,'Monitor',240,1),(6,'DVD drive',180,2),(7,'CD drive',90,2),(8,'Printer',270,3),(9,'Toner cartridge',66,3),(10,'DVD burner',180,2),(11,'Printer',40,7),(12,'Toner cartridge',54,7),(13,'DVD burner',78,7);
...
--
-- Temporary table structure for view `v_today`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `v_today` (
  `now` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Final view structure for view `d1`
--

/*!50001 DROP TABLE IF EXISTS `d1`*/;
/*!50001 DROP VIEW IF EXISTS `d1`*/;
...
/*!50001 VIEW `d1` AS select `products`.`Code` AS `Code`,`products`.`Name` AS `Name`,`products`.`Price` AS `Price`,`products`.`Manufacturer` AS `Manufacturer` from `products` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `d1_v8`
--

/*!50001 DROP TABLE IF EXISTS `d1_v8`*/;
/*!50001 DROP VIEW IF EXISTS `d1_v8`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `d1_v8` AS select `products`.`Code` AS `code`,`products`.`Name` AS `product`,`manu`.`Name` AS `manufacturer` from (`manu` join `products` on((`products`.`Code` = `manu`.`Code`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 DROP TABLE IF EXISTS `v_today`*/;
/*!50001 DROP VIEW IF EXISTS `v_today`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_today` AS select now() AS `now` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2018-01-19 11:41:50
